...
public class ChangedBehavior : EntityBehavior, IRenderer
{
    public double RenderOrder => 0;
    public int RenderRange => 9999;

    public double posDiffX, posDiffY, posDiffZ;
    public double rollDiff, pitchDiff;
    public double headpitchDiff;

    public float accum;
    public bool serverposApplied;

    public ICoreClientAPI capi;

    public ChangedBehavior(Entity entity) : base(entity)
    {
    ...
    public void OnRenderFrame(float deltaTime, EnumRenderStage stage)
    {
        ...
        entity.Pos.HeadPitch %= GameMath.TWOPI;
